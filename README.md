<img width="100%" src="https://capsule-render.vercel.app/api?type=waving&color=gradient&customColorList=6,12,19&height=180&section=header&text=Ana%20Lucia%20Juarez&fontSize=42&fontColor=fff&animation=fadeIn" alt="Ana Lucia Juarez"/>
...
Portfolio personal con **CMS** y dashboard `/admin` para gestión dinámica de contenidos, proyectos y perfil profesional.
...
[![Repo](https://img.shields.io/badge/Ver_repositorio-181717?style=for-the-badge&logo=github&logoColor=white)](https://github.com/manita02/APIGestionDePersonall)
...
Aplicación web **multiusuario** con autenticación, perfiles y administración de publicaciones mediante operaciones **CRUD**.

**Stack:** `Python` · `Flask` · `MySQL` · `APIs REST` · `HTML5` · `CSS3`

[![Repo](https://img.shields.io/badge/Ver_repositorio-181717?style=for-the-badge&logo=github&logoColor=white)](https://github.com/manita02/Good-Vibes-Blog)
...
<img width="100%" src="https://capsule-render.vercel.app/api?type=waving&color=gradient&customColorList=6,12,19&height=120&section=footer" alt=""/>
